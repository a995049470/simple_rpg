    ...
    SubShader
    {
        ...
        pass
        {
            ...
            float4 Fragment(Varyings i) : SV_TARGET
            {
                ...
                float2 uv = PositionToUV(TransformWorldToObject(i.positionWS));
                float3 dir = normalize(TransformWorldToObject(i.positionWS));
                float4 color = _CubeMap.Sample(sampler_CubeMap, dir);
